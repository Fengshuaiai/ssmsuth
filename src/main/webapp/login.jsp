...
<head>
    ...
    <script src="lib/jquery-3.4.1/jquery-3.4.1.min.js" type="s"></script>
    <script src="lib/layui-v2.5.4/layui.js" charset="utf-8"></script>
    <script src="lib/js/login/login.js" charset="utf-8"></script>
    <!--[if lt IE 9]>
    ...
    <script src="lib/jq-module/paigusu.min.js"></script>
</head>
<body>
        ...
        <div class="layui-form login-form">
            <form class="layui-form" action=""><!-- -->
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="username" lay-verify="required|account" placeholder="用户名或者邮箱" autocomplete="off" class="layui-input" value="aa">
                </div>
                <div class="layui-form-item">
